...
(function($) {
	...
	function _38e(_38f, _390) {
		...
		function _393(pp, type) {
			...
			//初始化状态
			var inited=pp.data("inited");
			var height= opts.height;
		/*	if(opts.region=="north"&&!opts.title){
				opts.title=" ";
			}*/
			//给带title的north面板加点高度 bzt
			if(opts.title&&opts.region=="north"&&!inited){
				height=opts.height?opts.height+35:opts.height
				pp.data("inited",true);
			}
			pp.panel("resize", {
				width : cc.width(),

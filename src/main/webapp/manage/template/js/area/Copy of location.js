 ...
 * @returns
 */
function getThirdParent(areaCD){
	var opt={
 ...
 * @param childCd
 */
function getSecondParent(areaCD){
	var opt={
			url:'/area/getSecondParent.html',
			type:'post',
			async:false,
			data:{
				areaCD:areaCD,
 ...
 * @param childCd
 */
function getfirstParent(areaCD){
	var opt={
			url:'/area/getfirstParent.html',
			type:'post',
			async:false,
			data:{
				areaCD:areaCD,
...
function CurrentAreaInfoInit(object){
	...
	if(areaCd!=undefined&&areaCd!=""){
		getThirdParent(areaCd);
		if(third==undefined||third=="")return false;
		getSecondParent(areaCd);
		getfirstParent(areaCd);
		chooseProvince(first.id,first.name,object)
		chooseCity(second.id,second.name,object)

...
public class ResMedia implements Serializable {
    ...
    public ResMedia(Map res) {
        if (res != null) {
            this.resTypeL1 = MapUtils.getInteger(res, "resTypeL1");
            this.objectId = MapUtils.getString(res, "objectId");
            this.fileKey = MapUtils.getString(res, "fileKey");
            this.resName = MapUtils.getString(res, "resName");
            this.resSize = MapUtils.getInteger(res, "resSize");
            this.resTypeL2 = MapUtils.getString(res, "resTypeL2");
            this.coverPath = MapUtils.getString(res, "coverPath");
            this.shareLevel = MapUtils.getInteger(res, "shareLevel");
            this.suffix = MapUtils.getString(res, "suffix");
        }
    }

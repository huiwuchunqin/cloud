 ...
 * 资源与学段关系表
 *
 * @author guohao 2015/12/02
 */
@Entity
@Table(name = "rel_res_section")
public class RelResSection implements Serializable {
    ...
    public RelResSection() {

    }

    public RelResSection(Integer id,
                         Integer resTypeL1,
                         Integer resId,
                         String resCode,
                         String sectionCode,

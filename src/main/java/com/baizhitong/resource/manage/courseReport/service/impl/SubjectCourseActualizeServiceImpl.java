...
/**
 * 
 * SubjectCourseActualizeServiceImpl 学科而课程实施统计实现
 * 
 * @author creator zhanglzh 2017年1月11日 上午11:32:06
 * @author updater
 *
 * @version 1.0.0
 */
@Service
public class SubjectCourseActualizeServiceImpl extends BaseService implements SubjectCourseActualizeService {
     ...
     */
    @Override
    public Page<Map<String, Object>> querySubjectCourseActualizeInfo(Map<String, Object> param, Integer page,
                    Integer rows) {
        return lessonReportDao.getSubjectCourseActualize(param, page, rows);
    }
    ...
    public Map<String, Object> queryTotalInfo(Map<String, Object> param) {
        return lessonReportDao.selectSubjectCourseActualizeTotal(param);
    }
    ...
    @Override
    public HSSFWorkbook getExcel(Integer endDate, String sectionCode, String yearTermCode, String subjectCode)
                    throws Exception {
        ...
        Page<Map<String, Object>> dataPage = this.querySubjectCourseActualizeInfo(param, 1, Integer.MAX_VALUE);
        List<Map<String, Object>> dataList = dataPage.getRows();
        HSSFWorkbook wb = new HSSFWorkbook();
        HSSFSheet sheet = wb.createSheet("学科课程实施统计");
        ...
        String[] name = { "学段", "学科", "课程数", "翻转课堂模式", "自主创建模式", "班级课程发布数", "班级课程实施数" };

 ...
 */
@Service
public class CourseAuthorReportServiceImpl implements CourseAuthorReportService {
     ...
     */
    @Override
    public Page queryAuthorReportInfo(Map<String, Object> param, Integer page, Integer rows) {
        return lessonReportDao.getCourseAuthorReport(param, page, rows);
    }
    ...
    public HSSFWorkbook getExcel(String startDate, String endDate, String sectionCode, String subjectCode,
        ...
        String[] name = { "姓名", "学校", "课程数", "翻转课堂模式", "自主创建模式" };
    ...
    public Map<String, Object> queryTotalInfo(Map<String, Object> param) {
        return lessonReportDao.selectCourseAuthorReportTotal(param);
    }
}

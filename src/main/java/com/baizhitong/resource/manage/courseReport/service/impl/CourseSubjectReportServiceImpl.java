 ...
 */
@Service
public class CourseSubjectReportServiceImpl implements CourseSubjectReportService {
     ...
     */
    @Override
    public Page querySubjectReportInfo(Map<String, Object> param, Integer page, Integer rows) {
        return lessonReportDao.getCourseSubjectReport(param, page, rows);
    }
    ...
    public HSSFWorkbook getExcel(String startDate, String endDate, String sectionCode, String shareLevel,
        ...
        Page<Map<String, Object>> dataPage = this.querySubjectReportInfo(param, 1, Integer.MAX_VALUE);
        ...
        String[] name = { "学段", "学科", "课程数", "翻转课堂模式", "自主创建模式" };
    ...
    public Map<String, Object> queryTotalInfo(Map<String, Object> param) {
        return lessonReportDao.selectCourseSubjectReportTotal(param);
    }
}

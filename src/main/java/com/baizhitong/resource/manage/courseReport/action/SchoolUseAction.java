...
/**
 * 学校使用情况 SchoolUseAction
 * 
 * @author creator gaow 2017年1月3日 下午2:40:45
 * @author updater
 *
 * @version 1.0.0
 */
@RequestMapping(value = "/manage/course/schoolUse")
@Controller
public class SchoolUseAction extends BaseAction {
    /** 学科使用情况统计Service */
    @Autowired
    private SchoolUseService schoolUseService;
    /** 学段Service */
    @Autowired
    ...
    public String jumpToUsageReportPage(ModelMap model) {
        ...
        return "/manage/courseReport/schoolUse.html";
    }
    ...
    @ResponseBody
    public Page<Map<String, Object>> getSchoolUseReportPage(String startDate, String endDate, String orgName,
        ...
        return schoolUseService.getSchoolLessonUse(page, rows, param);
    }
    ...
    public Map<String, Object> getTotalInfo(HttpServletRequest request, String startDate, String endDate,
        ...
        param.put("sectionCode", sectionCode);
        param.put("orgName", orgName);
        return schoolUseService.getSchoolLessonUseTotal(param);
    }
    ...
    public ModelAndView exportData(HttpServletRequest request, HttpServletResponse response, String sectionCode,
                    String orgName, String baseDateStart, String baseDateEnd, String fileName) {
        try {
            // 解密机构名称，避免中文乱码
            ...
            HSSFWorkbook wb = schoolUseService.getExcel(sectionCode, orgName, baseDateStart, baseDateEnd);
            wb.write(stream);
